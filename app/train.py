...
# AttributeError: 'str' object has no attribute 'precision_scoreAttribuAttributeError: 'str' object has no attribute 'precision_scoreAttributeError: 'str' object has no attribute 'precision_scoreteError: 'str' object has no attribute 'precision_score
...
def train(args):
    ...
    __save_loss(losses, loss_path)
    # print("precision: {:.2f}".format(x_test, y_test)))
    # print("recall: {:.2f}").
    # print ()
    print(precision_score(x_train, y_train))
